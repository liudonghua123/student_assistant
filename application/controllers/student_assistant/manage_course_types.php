<?php
/*
 * Manage_course_types Controller
 */
class Manage_course_types extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model(array('account/account_model', 'account/account_details_model', 'student_assistant/school_model', 'student_assistant/course_type_model'));
    ...
    function index($school_id = NULL) {
        ...
        if (isset($school_id)) {
            ...
            // Retrieve all course_types
            $data['course_types'] = $this->course_type_model->get();
            $data['school'] = NULL;
        }
        ...
        $this->load->view('student_assistant/manage_course_types', $data);
    }
