  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <div class="form-actions">
        <?php echo form_submit('manage_permission_submit', lang('settings_save'), 'class="btn btn-default btn-primary"'); ?>
        ...
        <?php if( $this->authorization->is_permitted('delete_permissions') && $action == 'update' && ! $is_system ): ?>
          ...
          <?php if( isset($permission->suspendedon) ): ?>
            <?php echo form_submit('manage_permission_unban', lang('permissions_unban'), 'class="btn btn-default btn-danger"'); ?>
          <?php else: ?>
            <?php echo form_submit('manage_permission_ban', lang('permissions_ban'), 'class="btn btn-default btn-danger"'); ?>
          <?php endif; ?>
        <?php endif; ?>
      </div>
