...
<div class="form-actions">
    <button type="submit" class="btn btn-default btn-primary"><?php echo lang('settings_save'); ?></button>
    <button type="reset" class="btn btn-default btn-small">Cancel</button>
</div>
