  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <div class="form-actions">
        <?php echo form_submit('manage_user_submit', lang('settings_save'), 'class="btn btn-default btn-primary"'); ?>
        ...
        <?php if( $this->authorization->is_permitted('ban_users') && $action == 'update' ): ?>
          ...
          <?php if( isset($update_account->suspendedon) ): ?>
            <?php echo form_submit('manage_user_unban', lang('users_unban'), 'class="btn btn-default btn-danger"'); ?>
          <?php else: ?>
            <?php echo form_submit('manage_user_ban', lang('users_ban'), 'class="btn btn-default btn-danger"'); ?>
          <?php endif; ?>
        <?php endif; ?>
      </div>
