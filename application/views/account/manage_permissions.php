          ...
          <tr>
            ...
            <th>
              <?php if( $this->authorization->is_permitted('create_users') ): ?>
                <a href="account/manage_permissions/save" class="btn btn-default btn-primary btn-small">Create<a>
              <?php endif; ?>
            </th>
          </tr>
        </thead>
            ...
            <tr>
              ...
              <td>
                <?php if( $this->authorization->is_permitted('update_permissions') ): ?>
                  <?php echo anchor('account/manage_permissions/save/'.$perm['id'], lang('website_update'), 'class="btn btn-default btn-small"'); ?>
                <?php endif; ?>
              </td>
            </tr>
          <?php endforeach; ?>
