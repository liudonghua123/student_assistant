  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <div class="form-actions">
        <?php echo form_submit('manage_role_submit', lang('settings_save'), 'class="btn btn-default btn-primary"'); ?>
        ...
        <?php if( $this->authorization->is_permitted('delete_roles') && $action == 'update' && ! $is_system ): ?>
          ...
          <?php if( isset($role->suspendedon) ): ?>
            <?php echo form_submit('manage_role_unban', lang('roles_unban'), 'class="btn btn-default btn-danger"'); ?>
          <?php else: ?>
            <?php echo form_submit('manage_role_ban', lang('roles_ban'), 'class="btn btn-default btn-danger"'); ?>
          <?php endif; ?>
        <?php endif; ?>
      </div>
