			...
			<?php if (isset($profile_info))
		{
            ...
            <div class="control-group <?php echo (form_error('profile_username')) ? 'error' : ''; ?>">
                ...
                <p>
					...
					<?php echo anchor('account/account_profile/index/delete', '<i class="icon-trash"></i> '.lang('profile_delete_picture'), 'class="btn btn-default"'); ?>
					<?php else : ?>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-default btn-primary"><?php echo lang('profile_save'); ?></button>
            </div>
