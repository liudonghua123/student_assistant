...
<link type="text/css" rel="stylesheet" href="<?php echo base_url().RES_DIR; ?>/css/common.css"/>
...
<script src="<?php echo base_url().RES_DIR; ?>/bootstrap/js/bootstrap-select.min.js"></script>
<script src="<?php echo base_url().RES_DIR; ?>/bootstrap/js/bootstrap-timepicker.js"></script>
<script src="<?php echo base_url().RES_DIR; ?>/mediaelement/mediaelement-and-player.min.js"></script>
<script src="<?php echo base_url().RES_DIR; ?>/js/stroll.js"></script>

<script src="<?php echo base_url().RES_DIR; ?>/js/common.js"></script>
