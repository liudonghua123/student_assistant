...
abstract class REST_Controller extends CI_Controller
{
	...
	*/
	...
	public function get($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->_get_args) ? $this->_xss_clean($this->_get_args[$key], $xss_clean) : NULL;
	}
	...
	public function options($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->_options_args) ? $this->_xss_clean($this->_options_args[$key], $xss_clean) : NULL;
	}
	...
	public function head($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->head_args) ? $this->_xss_clean($this->head_args[$key], $xss_clean) : NULL;
	}
	...
	public function post($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->_post_args) ? $this->_xss_clean($this->_post_args[$key], $xss_clean) : NULL;
	}
	...
	public function put($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->_put_args) ? $this->_xss_clean($this->_put_args[$key], $xss_clean) : NULL;
	}
	...
	public function delete($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->_delete_args) ? $this->_xss_clean($this->_delete_args[$key], $xss_clean) : NULL;
	}
	...
	public function patch($key = NULL, $xss_clean = TRUE)
	{
		...
		return array_key_exists($key, $this->_patch_args) ? $this->_xss_clean($this->_patch_args[$key], $xss_clean) : NULL;
	}
